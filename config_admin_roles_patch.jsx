...
(function () {
  ...
  function CredentialModal({ user, onClose }) {
    ...
    return <Modal open width={740} onClose={onClose} title="Credencial de acceso" footer={<><button className="btn" onClick={onClose}>Cerrar</button><button className="btn primary" onClick={() => window.print()}><Icon name="download" size={15} className="btn-ico" />Imprimir</button></>}>
